  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, "test_results"), {
        userId: user.uid,
        ...formData,
        createdAt: serverTimestamp(), // Menggunakan field 'createdAt' agar sinkron dengan halaman PersonalityTest
      });
      setIsSuccess(true)
    } catch (error) {
          ...
          {isSuccess ? (
            <>
              ...
              <div className="text-center mb-8 space-y-4">
                ...
                <p className="text-gray-700">Thank you for sharing your information with us. This will help our psychologists provide you with more personalized support.</p>
              </div>
